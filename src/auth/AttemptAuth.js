...
function AttemptAuth() {
    ...
    const attemptLogin = (val) => {
        ...
        try {
            ...
            axios.post(`${baseURL}login`, val).then(res => {
                const data = res.data;
                // console.log(res)
                ...
                if (data) {
                    ...
                    sessionStorage.setItem(globalText.x_auth_user, acakText("!@#$%$$#"))
                    sessionStorage.setItem(globalText.x_auth_access_token, acakText(data.token.access_token))
                    sessionStorage.setItem(globalText.x_auth_refresh_token, acakText(data.token.token_type))
                    sessionStorage.setItem(globalText.authorization, acakText(data.data.role))
            ...
            <_Row>
                ...
                <_Col sm={3} style={{ background: "#00ab3dba", padding: "40px", marginTop: "100px", boxShadow: "5px 5px #888888" }} >
                    <div style={{ textAlign: "center" }}>
                        ...
                        <p style={{ textAlign: "center", fontWeight: "bolder" }}> <span style={{ color: "#258fe6f7" }}> SI
                        </span> PEMANTAU HARGA </p>
                    ...
                    >
                        ...
                        <_Button label="Sign In" sm={2} submit />
